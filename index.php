...
<body>
  ...
  <header id="header" class="d-flex align-items-center ">
    <div class="container-fluid container-xxl d-flex align-items-center">
      ...
      <div id="logo" class="me-auto">
        ...
        <a href="index.php" class="scrollto"><img src="assets/img/logo shell.png" alt="" title=""></a>
      </div>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
      <h1 class="mb-4 pb-0"><span>SEA</span> YOU</h1>
      <p class="mb-4 pb-0">Selamatkan Lautmu, Selamatkan Bumimu</p>
      <a href="https://www.youtube.com/watch?v=KCDDDdwZ1EI" class="glightbox play-btn mb-4"></a>
      <a href="#about" class="about-btn scrollto">About SEA YOU</a>
    </div>
